...
/**
 * This is the item provider adapter for a {@link com.hsveclipse.phototoolkit.exif.DateTimeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DateTimeTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DateTimeType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DateTimeType_value_feature", "_UI_DateTimeType_type"),
				 ExifPackage.eINSTANCE.getDateTimeType_Value(),
				 true,
				 false,
				 false,
	...
	protected void addTagPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DateTimeType_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DateTimeType_tag_feature", "_UI_DateTimeType_type"),
				 ExifPackage.eINSTANCE.getDateTimeType_Tag(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		XMLGregorianCalendar labelValue = ((DateTimeType)object).getValue();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DateTimeType.class)) {
			case ExifPackage.DATE_TIME_TYPE__VALUE:
			case ExifPackage.DATE_TIME_TYPE__TAG:
