...
/**
 * This is the item provider adapter for a {@link com.oracle.xmlns.ord.meta.exif.StringType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringType_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringType_value_feature", "_UI_StringType_type"),
				 ExifPackage.eINSTANCE.getStringType_Value(),
				 true,
				 false,
				 false,
	...
	protected void addTagPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_StringType_tag_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_StringType_tag_feature", "_UI_StringType_type"),
				 ExifPackage.eINSTANCE.getStringType_Tag(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringType.class)) {
			case ExifPackage.STRING_TYPE__VALUE:
			case ExifPackage.STRING_TYPE__TAG:
