 ...
 * <ul>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.DateTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.DateTypeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateTypeImpl extends MinimalEObjectImpl.Container implements DateType {
	...
	protected EClass eStaticClass() {
		return ExifPackage.eINSTANCE.getDateType();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.DATE_TYPE__VALUE, oldValue, value));
	}
	...
	public void setTag(BigInteger newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.DATE_TYPE__TAG, oldTag, tag));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExifPackage.DATE_TYPE__VALUE:
				return getValue();
			case ExifPackage.DATE_TYPE__TAG:
				return getTag();
		}
