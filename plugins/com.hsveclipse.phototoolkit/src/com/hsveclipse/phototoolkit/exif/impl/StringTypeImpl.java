 ...
 * <ul>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.StringTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.StringTypeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringTypeImpl extends MinimalEObjectImpl.Container implements StringType {
	...
	protected EClass eStaticClass() {
		return ExifPackage.eINSTANCE.getStringType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.STRING_TYPE__VALUE, oldValue, value));
	}
	...
	public void setTag(BigInteger newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.STRING_TYPE__TAG, oldTag, tag));
	}
