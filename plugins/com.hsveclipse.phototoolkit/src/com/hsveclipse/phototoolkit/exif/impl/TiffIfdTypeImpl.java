...
import com.hsveclipse.phototoolkit.exif.BitsPerSampleType;
import com.hsveclipse.phototoolkit.exif.CompressionType;
...
import com.hsveclipse.phototoolkit.exif.PlanarConfigurationType;
...
import com.hsveclipse.phototoolkit.exif.WhitePointType;
import com.hsveclipse.phototoolkit.exif.YCbCrCoefficientsType;
import com.hsveclipse.phototoolkit.exif.YCbCrPositioningType;
import com.hsveclipse.phototoolkit.exif.YCbCrSubSamplingType;
 ...
 * <ul>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getImageWidth <em>Image Width</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getImageLength <em>Image Length</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getBitsPerSample <em>Bits Per Sample</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getCompression <em>Compression</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getPhotometricInterpretation <em>Photometric Interpretation</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getSamplesPerPixel <em>Samples Per Pixel</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getPlanarConfiguration <em>Planar Configuration</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getYCbCrSubSampling <em>YCb Cr Sub Sampling</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getYCbCrPositioning <em>YCb Cr Positioning</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getXResolution <em>XResolution</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getYResolution <em>YResolution</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getResolutionUnit <em>Resolution Unit</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getStripOffsets <em>Strip Offsets</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getRowsPerStrip <em>Rows Per Strip</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getStripByteCounts <em>Strip Byte Counts</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getJPEGInterChangeFormat <em>JPEG Inter Change Format</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getJPEGInterChangeFormatLength <em>JPEG Inter Change Format Length</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getTransferFunction <em>Transfer Function</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getWhitePoint <em>White Point</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getPrimaryChromaticities <em>Primary Chromaticities</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getYCbCrCoefficients <em>YCb Cr Coefficients</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getReferenceBlackWhite <em>Reference Black White</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getDateTime <em>Date Time</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getImageDescription <em>Image Description</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getMake <em>Make</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getModel <em>Model</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getSoftware <em>Software</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getArtist <em>Artist</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getCopyright <em>Copyright</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getTiffField1 <em>Tiff Field1</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getTiffField2 <em>Tiff Field2</em>}</li>
 *   <li>{@link com.hsveclipse.phototoolkit.exif.impl.TiffIfdTypeImpl#getTiffField3 <em>Tiff Field3</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
