 ...
 * <ul>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.DateTimeTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.DateTimeTypeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DateTimeTypeImpl extends MinimalEObjectImpl.Container implements DateTimeType {
	/**
	...
	protected EClass eStaticClass() {
		return ExifPackage.eINSTANCE.getDateTimeType();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.DATE_TIME_TYPE__VALUE, oldValue, value));
	}
	...
	public void setTag(BigInteger newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.DATE_TIME_TYPE__TAG, oldTag, tag));
	}
