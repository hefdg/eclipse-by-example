...
import com.oracle.xmlns.ord.meta.exif.ContrastType;
import com.oracle.xmlns.ord.meta.exif.CustomRenderedType;
...
import com.oracle.xmlns.ord.meta.exif.ExposureModeType;
import com.oracle.xmlns.ord.meta.exif.ExposureProgramType;
import com.oracle.xmlns.ord.meta.exif.FileSourceType;
import com.oracle.xmlns.ord.meta.exif.FlashType;
import com.oracle.xmlns.ord.meta.exif.GainControlType;
import com.oracle.xmlns.ord.meta.exif.LightSourceType;
import com.oracle.xmlns.ord.meta.exif.MeteringModeType;
...
import com.oracle.xmlns.ord.meta.exif.RealType;
import com.oracle.xmlns.ord.meta.exif.RepeatedFieldType;
import com.oracle.xmlns.ord.meta.exif.ResolutionType;
import com.oracle.xmlns.ord.meta.exif.SaturationType;
import com.oracle.xmlns.ord.meta.exif.SceneCaptureType;
import com.oracle.xmlns.ord.meta.exif.SensingMethodType;
import com.oracle.xmlns.ord.meta.exif.SharpnessType;
...
import com.oracle.xmlns.ord.meta.exif.SubjectDistanceRangeType;
import com.oracle.xmlns.ord.meta.exif.SubjectLocationType;
import com.oracle.xmlns.ord.meta.exif.UuidType;
import com.oracle.xmlns.ord.meta.exif.WhiteBalanceType;
 ...
 * <ul>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExifVersion <em>Exif Version</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFlashpixVersion <em>Flashpix Version</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getColorSpace <em>Color Space</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getComponentsConfiguration <em>Components Configuration</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getCompressedBitsPerPixel <em>Compressed Bits Per Pixel</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getPixelXDimension <em>Pixel XDimension</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getPixelYDimension <em>Pixel YDimension</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getMakerNote <em>Maker Note</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getUserComment <em>User Comment</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getRelatedSoundFile <em>Related Sound File</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getDateTimeOriginal <em>Date Time Original</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getDateTimeDigitized <em>Date Time Digitized</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubSecTime <em>Sub Sec Time</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubSecTimeOriginal <em>Sub Sec Time Original</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubSecTimeDigitized <em>Sub Sec Time Digitized</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExposureTime <em>Exposure Time</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFNumber <em>FNumber</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExposureProgram <em>Exposure Program</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSpectralSensitivity <em>Spectral Sensitivity</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getISOSpeedRatings <em>ISO Speed Ratings</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getOECF <em>OECF</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getShutterSpeedValue <em>Shutter Speed Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getApertureValue <em>Aperture Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getBrightnessValue <em>Brightness Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExposureBiasValue <em>Exposure Bias Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getMaxApertureValue <em>Max Aperture Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubjectDistance <em>Subject Distance</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getMeteringMode <em>Metering Mode</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getLightSource <em>Light Source</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFlash <em>Flash</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFocalLength <em>Focal Length</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubjectArea <em>Subject Area</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFlashEnergy <em>Flash Energy</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSpatialFrequencyResponse <em>Spatial Frequency Response</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFocalPlaneXResolution <em>Focal Plane XResolution</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFocalPlaneYResolution <em>Focal Plane YResolution</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFocalPlaneResolutionUnit <em>Focal Plane Resolution Unit</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubjectLocation <em>Subject Location</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExposureIndex <em>Exposure Index</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSensingMethod <em>Sensing Method</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFileSource <em>File Source</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSceneType <em>Scene Type</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getCFAPattern <em>CFA Pattern</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getCustomRendered <em>Custom Rendered</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExposureMode <em>Exposure Mode</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getWhiteBalance <em>White Balance</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getDigitalZoomRatio <em>Digital Zoom Ratio</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getFocalLengthIn35mmFilm <em>Focal Length In35mm Film</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSceneCaptureType <em>Scene Capture Type</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getGainControl <em>Gain Control</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getContrast <em>Contrast</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSaturation <em>Saturation</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSharpness <em>Sharpness</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getDeviceSettingDescription <em>Device Setting Description</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getSubjectDistanceRange <em>Subject Distance Range</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getImageUniqueID <em>Image Unique ID</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getGamma <em>Gamma</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExifField1 <em>Exif Field1</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExifField2 <em>Exif Field2</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getExifField3 <em>Exif Field3</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.ExifIfdTypeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
