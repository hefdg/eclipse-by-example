 ...
 * <ul>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.TimeTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.oracle.xmlns.ord.meta.exif.impl.TimeTypeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeTypeImpl extends MinimalEObjectImpl.Container implements TimeType {
	...
	protected EClass eStaticClass() {
		return ExifPackage.eINSTANCE.getTimeType();
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.TIME_TYPE__VALUE, oldValue, value));
	}
	...
	public void setTag(BigInteger newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExifPackage.TIME_TYPE__TAG, oldTag, tag));
	}
